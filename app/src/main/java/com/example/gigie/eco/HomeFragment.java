    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_recycle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                map.addMarker(new MarkerOptions().position(new LatLng(14, 100.38))
                                .title("Recycle Waste")
        ...
        btn_foodscrape.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.addMarker(new MarkerOptions().position(new LatLng(13.6524, 100.4944))
                                .title("Food Scrap")
        ...
        btn_landfill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                map.addMarker(new MarkerOptions().position(new LatLng(13.786, 100.44))
                                .title("Landfill")
        ...
        btn_freecycle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                map.addMarker(new MarkerOptions().position(new LatLng(13.89, 100.55))
