...
public class LandFillFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.create_landfill, null, true);
...
//                                landfill.put("stone", stone.isChecked());
                                ...
                                if (concrete.isChecked()) {
                                    landfill.put("concrete", true);
                                } else {
                                    landfill.put("concrete", false);
                                }

                                if (sand.isChecked()) {
                                    landfill.put("sand", true);
                                } else {
                                    landfill.put("sand", false);
                                }

                                if (stone.isChecked()) {
                                    landfill.put("stone", true);
                                } else {
                                    landfill.put("stone", false);
                                }
